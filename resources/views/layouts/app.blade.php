        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                <a class="sidebar-brand" href="index.html">
                    <span class="align-middle">Kouboard</span>
                </a>
                ...
                <div class="container-fluid">
                    <div class="row text-muted">
                        <div class="col-6 text-start">
                            <p class="mb-0">
                                <a class="text-muted" href="https://github.com/kououdev" target="_blank">
                                    <strong>Kououdev</strong>
                                </a>
                                -
                                <a class="text-muted" href="https://github.com/kououdev/laravel-blade-jquery"
                                    target="_blank">
                                    <strong>Laravel Blade JQuery</strong>
                                </a> &copy;
                            </p>
                        </div>
